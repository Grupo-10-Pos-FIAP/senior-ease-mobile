...
- **Matrícula** — código de exibição gerado no client sem checagem de
  unicidade contra outros usuários (a coleção `users` não é consultável em
  lista pelas regras acima); o UID do Firebase continua sendo o identificador
  real internamente
